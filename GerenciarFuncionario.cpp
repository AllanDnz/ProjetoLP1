...
void GerenciarFuncionario::excluirRegistroDeFuncionario()
{
    ...
    { // procura na lista de funcionarios cadastrados o codigo lido
        if (funcionarios.at(i)->getCodigo() == codigo)
        {
            if (funcionarios.at(i)->getDesignacao() == "Gerente" || funcionarios.at(i)->getDesignacao() == "Presidente" || funcionarios.at(i)->getDesignacao() == "presidente" || funcionarios.at(i)->getDesignacao() == "gerente")
            {
        ...
        else //caso seja um tipo de funcionario que possa excluir segue para a confirmação da exclusão do funcionario de tal codigo
        { 
            cout << "Voce deseja excluir o funcionaro de codigo: " << funcionarios.at(i)->getCodigo() << " e nome: " << funcionarios.at(i)->getNome() << ":(s/n) " << endl; // mensagem de confirmação de deleção
